...
To use the Kemp Load Balancer Universal Orchestrator extension, you **must** create the  Certificate Store Type. This only needs to happen _once_ per Keyfactor Command instance.
